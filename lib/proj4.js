!function (t, s) {
    ...
    function r(t) {
        ...
        [["standard_parallel_1", "Standard_Parallel_1"], ["standard_parallel_1", "Latitude of 1st standard parallel"], ["standard_parallel_2", "Standard_Parallel_2"], ["standard_parallel_2", "Latitude of 2nd standard parallel"], ["false_easting", "False_Easting"], ["false_easting", "False easting"], ["false-easting", "Easting at false origin"], ["false_northing", "False_Northing"], ["false_northing", "False northing"], ["false_northing", "Northing at false origin"], ["central_meridian", "Central_Meridian"], ["central_meridian", "Longitude of natural origin"], ["central_meridian", "Longitude of false origin"], ["latitude_of_origin", "Latitude_Of_Origin"], ["latitude_of_origin", "Central_Parallel"], ["latitude_of_origin", "Latitude of natural origin"], ["latitude_of_origin", "Latitude of false origin"], ["scale_factor", "Scale_Factor"], ["k0", "scale_factor"], ["latitude_of_center", "Latitude_Of_Center"], ["latitude_of_center", "Latitude_of_center"], ["lat0", "latitude_of_center", n], ["longitude_of_center", "Longitude_Of_Center"], ["longitude_of_center", "Longitude_of_center"], ["longc", "longitude_of_center", n], ["x0", "false_easting", s], ["y0", "false_northing", s], ["long0", "central_meridian", n], ["lat0", "latitude_of_origin", n], ["lat0", "standard_parallel_1", n], ["lat1", "standard_parallel_1", n], ["lat2", "standard_parallel_2", n], ["azimuth", "Azimuth"], ["alpha", "azimuth", n], ["srsCode", "name"]].forEach(function (s) {
            return e(t, s)
        }), t.long0 || !t.longc || "Albers_Conic_Equal_Area" !== t.projName && "Lambert_Azimuthal_Equal_Area" !== t.projName || (t.long0 = t.longc), t.lat_ts || !t.lat1 || "Stereographic_South_Pole" !== t.projName && "Polar Stereographic (variant B)" !== t.projName ? !t.lat_ts && t.lat0 && "Polar_Stereographic" === t.projName && (t.lat_ts = t.lat0, t.lat0 = n(t.lat0 > 0 ? 90 : -90)) : (t.lat0 = n(t.lat1 > 0 ? 90 : -90), t.lat_ts = t.lat1)
    }
    ...
    function T(t, s, i) {
        ...
        t:for (var n = 0; n < t.grids.length; n++) {
            ...
            if (null !== r.grid) for (var o = r.grid.subgrids, l = 0, u = o.length; l < u; l++) {
                var c = o[l], M = (Math.abs(c.del[1]) + Math.abs(c.del[0])) / 1e4, f = c.ll[0] - M, d = c.ll[1] - M,
                    p = c.ll[0] + (c.lim[0] - 1) * c.del[0] + M, m = c.ll[1] + (c.lim[1] - 1) * c.del[1] + M;
                if (!(d > a.y || f > a.x || m < a.y || p < a.x) && (h = j(a, s, c), !isNaN(h.x))) break t
    ...
    function V(t) {
        var s, i, a, h, e, n, r, o = t.lat, l = t.lon, u = 6378137, c = K(o), M = K(l);
        r = Math.floor((l + 180) / 6) + 1, 180 === l && (r = 60), o >= 56 && o < 64 && l >= 3 && l < 12 && (r = 32), o >= 72 && o < 84 && (l >= 0 && l < 9 ? r = 31 : l >= 9 && l < 21 ? r = 33 : l >= 21 && l < 33 ? r = 35 : l >= 33 && l < 42 && (r = 37)), n = K(6 * (r - 1) - 180 + 3), s = u / Math.sqrt(1 - .00669438 * Math.sin(c) * Math.sin(c)), i = Math.tan(c) * Math.tan(c), a = .006739496752268451 * Math.cos(c) * Math.cos(c);
    ...
    function ut(t, s, i, a) {
        var h;
        return t < wt ? (a.value = Ni.AREA_0, h = 0) : (h = Math.atan2(s, i), Math.abs(h) <= At ? a.value = Ni.AREA_0 : h > At && h <= xt + At ? (a.value = Ni.AREA_1, h -= xt) : h > xt + At || h <= -(xt + At) ? (a.value = Ni.AREA_2, h = h >= 0 ? h - Pt : h + Pt) : (a.value = Ni.AREA_3, h += xt)), h
    }
    ...
    var ft = 1, dt = 2, pt = 3, mt = 4, yt = 5, _t = 484813681109536e-20, xt = Math.PI / 2, gt = .16666666666666666,
        vt = .04722222222222222, bt = .022156084656084655, wt = 1e-10, Nt = .017453292519943295, Et = 57.29577951308232,
        At = Math.PI / 4, Ct = 2 * Math.PI, Pt = 3.14159265359, St = {};
    ...
    }, qt = 1, Rt = /\s/, Lt = /[A-Za-z]/, Gt = /[A-Za-z84_]/, Tt = /[,\]]/, jt = /[\d\.E\-\+]/;
    s.prototype.readCharicter = function () {
        ...
        if (Tt.test(t)) return this.word = this.word.trim(), void this.afterItem(t);
        ...
        if (!jt.test(t)) {
            if (Tt.test(t)) return this.word = parseFloat(this.word), void this.afterItem(t);
        ...
        if (Gt.test(t)) this.word += t; else {
            ...
            if (!Tt.test(t)) throw new Error("havn't handled \"" + t + '" in keyword yet, index ' + this.place);
            this.afterItem(t)
        }
        ...
        {
            if (!Tt.test(t)) throw new Error("havn't handled \"" + t + '" in neutral yet, index ' + this.place);
            this.afterItem(t)
        }
    ...
    var Ft = ["PROJECTEDCRS", "PROJCRS", "GEOGCS", "GEOCCS", "PROJCS", "LOCAL_CS", "GEODCRS", "GEODETICCRS", "GEODETICDATUM", "ENGCRS", "ENGINEERINGCRS"],
        Dt = ["3857", "900913", "3785", "102113"], Ut = function (t, s) {
            ...
            forward: function (t) {
                ...
                if (this.sphere) a = this.x0 + this.a * this.k0 * Ht(s - this.long0), h = this.y0 + this.a * this.k0 * Math.log(Math.tan(At + .5 * i)); else {
    ...
    var as = function (t, s, i) {
            ...
            return s.datum_type === pt && (e = 6378137, n = 6356752.314, r = .0066943799901413165), h !== r || a !== e || G(t.datum_type) || G(s.datum_type) ? (i = k(i, h, a), G(t.datum_type) && (i = R(i, t.datum_type, t.datum_params)), G(s.datum_type) && (i = L(i, s.datum_type, s.datum_params)), i = q(i, r, e, n), s.datum_type !== pt || 0 === T(s, !0, i) ? i : void 0) : i
        }, hs = function (t, s, i) {
    ...
    var ys = .01068115234375, _s = function (t) {
            ...
            inverse: function (t) {
                ...
                if (Math.abs(s) <= 2.623395162778) {
                    ...
                    i = Math.atan2(n * l, ws(o, l * r)), s = Math.atan2(o, l * r), a = Ht(s + this.long0), h = As(this.cgb, i)
                } else a = 1 / 0, h = 1 / 0;
                return t.x = a, t.y = h, t
            },
            ...
            init: function () {
                ...
                s *= s, this.rc = Math.sqrt(1 - this.es) / (1 - this.es * t * t), this.C = Math.sqrt(1 + this.es * s * s / (1 - this.es)), this.phic0 = Math.asin(t / this.C), this.ratexp = .5 * this.C * this.e, this.K = Math.tan(.5 * this.phic0 + At) / (Math.pow(Math.tan(.5 * this.lat0 + At), this.C) * qs(this.e * t, this.ratexp))
            }, forward: function (t) {
                var s = t.x, i = t.y;
                return t.y = 2 * Math.atan(this.K * Math.pow(Math.tan(.5 * i + At), this.C) * qs(this.e * Math.sin(i), this.ratexp)) - xt, t.x = this.C * s, t
            }, inverse: function (t) {
                for (var s = t.x / this.C, i = t.y, a = Math.pow(Math.tan(.5 * i + At) / this.K, 1 / this.C), h = Rs; h > 0 && (i = 2 * Math.atan(a * qs(this.e * Math.sin(t.y), -.5 * this.e)) - xt, !(Math.abs(i - t.y) < 1e-14)); --h) t.y = i;
            ...
            inverse: function (t) {
                var s, i, a, h, e;
                if (t.x = (t.x - this.x0) / this.a, t.y = (t.y - this.y0) / this.a, t.x /= this.k0, t.y /= this.k0, e = ws(t.x, t.y)) {
            ...
            inverse: function (t) {
                ...
                if (Math.abs(this.coslat0) <= wt) {
                    ...
                    t.x *= this.con, t.y *= this.con, a = n * this.cons / (2 * this.a * this.k0), i = this.con * Kt(this.e, a), s = this.con * Ht(this.con * this.long0 + Math.atan2(t.x, -1 * t.y))
                } else h = 2 * Math.atan(n * this.cosX0 / (2 * this.a * this.k0 * this.ms1)), s = this.long0, n <= wt ? e = this.X0 : (e = Math.asin(Math.cos(h) * this.sinX0 + t.y * Math.sin(h) * this.cosX0 / n), s = Ht(this.long0 + Math.atan2(t.x * Math.sin(h), n * this.cosX0 * Math.cos(h) - t.y * this.sinX0 * Math.sin(h)))), i = -1 * Kt(this.e, Math.tan(.5 * (xt + e)));
            ...
            inverse: function (t) {
                ...
                if (t.x = (t.x - this.x0) * (1 / this.a), t.y = (t.y - this.y0) * (1 / this.a), this.no_rot ? (i = t.y, s = t.x) : (i = t.x * this.cosrot - t.y * this.sinrot, s = t.y * this.cosrot + t.x * this.sinrot + this.u_0), a = Math.exp(-this.BrA * i), h = .5 * (a - 1 / a), e = .5 * (a + 1 / a), n = Math.sin(this.BrA * s), r = (n * this.cosgam + h * this.singam) / e, Math.abs(Math.abs(r) - 1) < wt) o.x = 0, o.y = r < 0 ? -xt : xt; else {
                    if (o.y = this.E / Math.sqrt((1 + r) / (1 - r)), o.y = Kt(this.e, Math.pow(o.y, 1 / this.B)), o.y === 1 / 0) throw new Error;
            ...
            inverse: function (t) {
                ...
                if (0 !== s && (o = Math.atan2(i * n, i * r)), 0 !== s || this.ns > 0) {
                    if (i = 1 / this.ns, a = Math.pow(s / (this.a * this.f0), i), -9999 === (h = Kt(this.e, a))) return null
                } else h = -xt;
            ...
            init: function () {
                ...
                if (a = Ht(a - this.long0), this.sphere) s = this.a * Math.asin(Math.cos(h) * Math.sin(a)), i = this.a * (Math.atan2(Math.tan(h), Math.cos(a)) - this.lat0); else {
                    var e = Math.sin(h), n = Math.cos(h), r = Ks(this.a, this.e, e), o = Math.tan(h) * Math.tan(h),
                ...
                if (this.sphere) {
                    ...
                    var o = Ks(this.a, this.e, Math.sin(r)), l = o * o * o / this.a / this.a * (1 - this.es),
        ...
        ai = .0664021164021164, hi = .016415012942191543, ei = {
            ...
            forward: function (t) {
                ...
                if (c = Ht(c - this.long0), this.sphere) {
                    if (e = Math.sin(M), u = Math.cos(M), a = Math.cos(c), this.mode === this.OBLIQ || this.mode === this.EQUIT) {
                        ...
                        i = At - .5 * M, s = (i = 2 * (this.mode === this.S_POLE ? Math.cos(i) : Math.sin(i))) * Math.sin(c), i *= a
                    }
                } else {
            ...
            init: function () {
                ...
                var s = t.x, i = t.y, a = Ht(s - this.long0), h = Js(i - this.lat0);
                return t.x = this.x0 + this.a * a * this.rc, t.y = this.y0 + this.a * h, t
            }, inverse: function (t) {
                var s = t.x, i = t.y;
                return t.x = Ht(this.long0 + (s - this.x0) / (this.a * this.rc)), t.y = Js(this.lat0 + (i - this.y0) / this.a), t
            ...
            init: function () {
                ...
                if (a = n * Math.sin(e), this.sphere) Math.abs(e) <= wt ? (s = this.a * n, i = -1 * this.a * this.lat0) : (s = this.a * Math.sin(a) / Math.tan(e), i = this.a * (Js(e - this.lat0) + (1 - Math.cos(a)) / Math.tan(e))); else if (Math.abs(e) <= wt) s = this.a * n, i = -1 * this.ml0; else {
            ...
            init: function () {
                ...
                var E = this.lat0 + N * _t * 1e5, A = this.long0 + b;
            ...
            init: function () {
                ...
                var e = 0;
                if (0 !== i && (e = Math.atan2(s * t.x, s * t.y)), this.sphere) return h = Ht(this.long0 + e / this.ns), a = Js(this.g - i / this.a), t.x = h, t.y = a, t;
        ...
        Ni = {AREA_0: 1, AREA_1: 2, AREA_2: 3, AREA_3: 4}, Ei = {
            init: function () {
                this.x0 = this.x0 || 0, this.y0 = this.y0 || 0, this.lat0 = this.lat0 || 0, this.long0 = this.long0 || 0, this.lat_ts = this.lat_ts || 0, this.title = this.title || "Quadrilateralized Spherical Cube", this.lat0 >= xt - At / 2 ? this.face = wi.TOP : this.lat0 <= -(xt - At / 2) ? this.face = wi.BOTTOM : Math.abs(this.long0) <= At ? this.face = wi.FRONT : Math.abs(this.long0) <= xt + At ? this.face = this.long0 > 0 ? wi.RIGHT : wi.LEFT : this.face = wi.BACK, 0 !== this.es && (this.one_minus_f = 1 - (this.a - this.b) / this.a, this.one_minus_f_squared = this.one_minus_f * this.one_minus_f)
            }, forward: function (t) {
                var s, i, a, h, e, n, r = {x: 0, y: 0}, o = {value: 0};
                if (t.x -= this.long0, s = 0 !== this.es ? Math.atan(this.one_minus_f_squared * Math.tan(t.y)) : t.y, i = t.x, this.face === wi.TOP) h = xt - s, i >= At && i <= xt + At ? (o.value = Ni.AREA_0, a = i - xt) : i > xt + At || i <= -(xt + At) ? (o.value = Ni.AREA_1, a = i > 0 ? i - Pt : i + Pt) : i > -(xt + At) && i <= -At ? (o.value = Ni.AREA_2, a = i + xt) : (o.value = Ni.AREA_3, a = i); else if (this.face === wi.BOTTOM) h = xt + s, i >= At && i <= xt + At ? (o.value = Ni.AREA_0, a = -i + xt) : i < At && i >= -At ? (o.value = Ni.AREA_1, a = -i) : i < -At && i >= -(xt + At) ? (o.value = Ni.AREA_2, a = -i - xt) : (o.value = Ni.AREA_3, a = i > 0 ? -i + Pt : -i - Pt); else {
                    var l, u, c, M, f, d;
        ...
        Pi = .8487, Si = 1.3523, Ii = Et / 5, Oi = 1 / Ii, ki = 18, qi = function (t, s) {
            ...
            init: function () {
                ...
                if (s.y >= 1) s.x /= Ai[ki][0], s.y = t.y < 0 ? -xt : xt; else {
                    ...
                    }, h, wt, 100), s.x /= qi(Ai[i], h), s.y = (5 * i + h) * Nt, t.y < 0 && (s.y = -s.y)
                }
        ...
        }, Ti = {N_POLE: 0, S_POLE: 1, EQUIT: 2, OBLIQ: 3}, ji = {
            h: {def: 1e5, num: !0},
            ...
            init: function () {
                ...
                }.bind(this)), Math.abs(Math.abs(this.lat0) - xt) < wt ? this.mode = this.lat0 < 0 ? Ti.S_POLE : Ti.N_POLE : Math.abs(this.lat0) < wt ? this.mode = Ti.EQUIT : (this.mode = Ti.OBLIQ, this.sinph0 = Math.sin(this.lat0), this.cosph0 = Math.cos(this.lat0)), this.pn1 = this.h / this.a, this.pn1 <= 0 || this.pn1 > 1e10) throw new Error("Invalid height");
        ...
        }, Fi = 1.340264, Di = -.081106, Ui = 893e-6, Qi = .003796, Wi = Math.sqrt(3) / 2, Hi = {
            init: function () {
                this.es = 0, this.long0 = void 0 !== this.long0 ? this.long0 : 0
            }, forward: function (t) {
                var s = Ht(t.x - this.long0), i = t.y, a = Math.asin(Wi * Math.sin(i)), h = a * a, e = h * h * h;
                return t.x = s * Math.cos(a) / (Wi * (Fi + 3 * Di * h + e * (7 * Ui + 9 * Qi * h))), t.y = a * (Fi + Di * h + e * (Ui + Qi * h)), t.x = this.a * t.x + this.x0, t.y = this.a * t.y + this.y0, t
            }, inverse: function (t) {
                t.x = (t.x - this.x0) / this.a, t.y = (t.y - this.y0) / this.a;
                var s, i, a, h, e, n, r = t.y;
                for (n = 0; n < 12 && (s = r * r, i = s * s * s, a = r * (Fi + Di * s + i * (Ui + Qi * s)) - t.y, h = Fi + 3 * Di * s + i * (7 * Ui + 9 * Qi * s), r -= e = a / h, !(Math.abs(e) < 1e-9)); ++n) ;
                return s = r * r, i = s * s * s, t.x = Wi * t.x * (Fi + 3 * Di * s + i * (7 * Ui + 9 * Qi * s)) / Math.cos(r), t.y = Math.asin(Math.sin(r) / Wi), t.x = Ht(t.x + this.long0), t
    ...
    return W.defaultDatum = "WGS84", W.Proj = Projection, W.WGS84 = new W.Proj("WGS84"), W.Point = Point, W.toPoint = es, W.defs = o, W.nadgrid = function (t, s) {
        var i = new DataView(s), a = N(i), h = E(i, a), e = {header: h, subgrids: C(i, h, a)};
        return is[t] = e, e
    }, W.transform = D, W.mgrs = ms, W.version = "2.11.0", function (proj4) {
        proj4.Proj.projections.add(vs), proj4.Proj.projections.add(Is), proj4.Proj.projections.add(ks), proj4.Proj.projections.add(Gs), proj4.Proj.projections.add(Ts), proj4.Proj.projections.add(js), proj4.Proj.projections.add(zs), proj4.Proj.projections.add(Fs), proj4.Proj.projections.add(Ds), proj4.Proj.projections.add(Zs), proj4.Proj.projections.add(ei), proj4.Proj.projections.add(ri), proj4.Proj.projections.add(oi), proj4.Proj.projections.add(ui), proj4.Proj.projections.add(ci), proj4.Proj.projections.add(fi), proj4.Proj.projections.add(di), proj4.Proj.projections.add(pi), proj4.Proj.projections.add(yi), proj4.Proj.projections.add(_i), proj4.Proj.projections.add(xi), proj4.Proj.projections.add(gi), proj4.Proj.projections.add(vi), proj4.Proj.projections.add(bi), proj4.Proj.projections.add(Ei), proj4.Proj.projections.add(Li), proj4.Proj.projections.add(Gi), proj4.Proj.projections.add(Bi), proj4.Proj.projections.add(zi), proj4.Proj.projections.add(Hi)
    }(W), W
});
